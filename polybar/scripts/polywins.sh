...
active_text_color="#405366"
active_bg="#D5DDE6"
active_underline="#93BFEA"

inactive_text_color="#A6ACB3"
inactive_bg="#405366"
inactive_underline="#6A6E72"

separator="|"
show="window_title" # options: window_title, window_class, window_classname
forbidden_classes="Polybar Conky Gmruni jgmenu"
empty_desktop_message="bspwm Archlinux  is the best."
